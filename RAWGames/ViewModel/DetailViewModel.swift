...
class DetailViewModel {
    ...
    func touchLiked(id:Int) -> Bool{
        ...
        isSelected = !gameDetail.isSelected
        
        if gameDetail.isSelected {
            coreDataManager.updateFavorite(event: gameDetail, name: gameDetail.name ?? "", released: gameDetail.released ?? "", rating: gameDetail.rating , background_image: gameDetail.background_image ?? "", isSelected: isSelected , attDescription: gameDetail.attDescription ?? "" ,id: Int(gameDetail.id ))
